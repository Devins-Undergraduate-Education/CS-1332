...
public class ArrayStack<T> {
    ...
    /**
     * Resizes the ArrayStack to 2 times its current capacity.
     *
     * @param array which represents the passed in ArrayStack
    ...
    public T pop() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("The ArrayStack is empty.");
        } else {
    ...
    public T peek() {
        if (size == 0) {
            throw new java.util.NoSuchElementException("The ArrayStack is empty! No element to be found!");
        }
